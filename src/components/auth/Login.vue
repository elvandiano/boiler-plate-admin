<template>
  <div id="bgrn" class="app flex-row align-items-center">
    <div class="container">
            ...
            <b-card no-body class="p-4" id="dataInput">
              <b-card-body>
                <b-form>
                  ...
                  <a style="color: whitesmoke" >Belum memiliki akun? <i style="color: #051d1a"><router-link to="/register">Register</router-link></i></a>
                  ...
                  <b-row>
                    <b-col cols="12">
                      <div align="center">
                        <b-button type="submit" @click="onLogin" variant="primary" style=" border-radius: 20px; width: 80%" class="px-4">Login
                        </b-button>
                      </div>
                    </b-col>
                  </b-row>
